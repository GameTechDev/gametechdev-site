...
This sample project ([Vanilla.sln](https://github.com/GameTechDev/XeGTAO/tree/master/VisualStudio/Vanilla.sln)) was tested with Visual Studio 2019 16.10.3, DirectX 12 GPU, Windows version 10.0.19041. 

XeGTAO OFF/ON comparison in Amazon Lumberyard Bistro; click on image to embiggen:  
{% include image-compare.html image_left="images/exteriorASSAO.png" image_right="images/exteriorXeGTAO.png" title_left="ASSAO" title_right="XeGTAO"%}

[![thumb1](images/thumb-exterior-off.png)](exterior_compare.html)
[![thumb2](images/thumb-exterior-GTAO.png)](exterior_compare.html) 
[![thumb3](images/thumb-interior-off.png)](interior_compare.html) 
[![thumb4](images/thumb-interior-GTAO.png)](interior_compare.html)  
 ...
 * [**XeGTAO.h**](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.h) provides the glue between the user codebase and the effect; this is where macro definitions, settings, constant buffer updates and optional ImGui debug settings are handled.
 * [**XeGTAO.hlsli**](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.hlsli) provides the core shader code for the effect.

These two files contain the minimum required to integrate the effect, with the amount of work depending on the specific platform and engine details. In an ideal case, the user codebase can include these two files above with little or no modifications, and provide additional resources including working textures, a constant buffer, compute shaders, as well as codebase-specific shader code used to load screen space normals and etc, as shown in the usage example (see [vaGTAO.h](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Effects/vaGTAO.h), [vaGTAO.cpp](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Effects/vaGTAO.cpp), [vaGTAO.hlsl](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Effects/vaGTAO.hlsl)).
 ...
 * [**PrefilterDepths pass**](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.hlsli#L486): inputs depth buffer; performs input depth conversion to viewspace and generation of depth MIP chain; outputs intermediary viewspace depth buffer with a MIP chain
 * [**MainPass**](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.hlsli#L167): inputs intermediary depth buffer and (optional) screen space normals; performs the core GTAO algorithm; outputs unfiltered AO term and intermediary edge information by the denoiser
 * [**Denoise**](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.hlsli#L596): inputs unfiltered AO term and intermediary edge information; performs the spatial denoise filter; outputs the final AO term
...
<img src="images/reference-raytracer.png" alt="Reference Raytracer" width="100%"/>
...
<img src="images/sample-distribution-power.png" alt="denoising" width="100%"/>
...
<img src="images/thin-occluders-heuristic.png" alt="thin occluders" width="100%"/>
...
<img src="images/interior-assao-medium-vs-gtao-high.png" alt="ASSAO vs GTAO" width="100%"/>
...
See [XeGTAO.h](https://github.com/GameTechDev/XeGTAO/tree/master/Source/Rendering/Shaders/XeGTAO.h#L14)
